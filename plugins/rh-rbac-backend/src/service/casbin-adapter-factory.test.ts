...
describe('CasbinAdapterFactory', () => {
  it('should build adapter from better-sqlite3 configuration', async () => {
  ...
  //
  it('should build adapter from postgres configuration', async () => {
  ...
  it('should fail to build adapter with unknown configuration', async () => {
